...
\comment{is this necessary? too much detail? maybe there's no need for an argument, it's the inner product of a feature transform.}
...
% TODO: change j index to i index?
\begin{proof}
	\hphantom{~}
