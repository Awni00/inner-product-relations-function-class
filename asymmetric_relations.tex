...
\begin{proof}
    ...
    \[\tilde{\epsilon} \coloneq \frac{\sqrt{2 \delta^{-d} R_{\max} (2 R_{\max} + \epsilon)} - 2 \delta^{-d / 2} R_{\max}}{2 \delta^{-d} R_{\max}} = \calO \paren{\sqrt{\frac{\delta^d\, \epsilon}{R_{\max}}}}\]
