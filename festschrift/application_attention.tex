...
Finally, we mention how this implies a related result for ``relational attention,'' which has recently be shown to be a powerful modification of the standard attention mechanism for relational reasoning tasks
