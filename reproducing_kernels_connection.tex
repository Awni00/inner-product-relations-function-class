...
Recall that any two Hilbert spaces with equal dimensions are isometrically isomorphic. Hence, First, note that, by the Riesz representation theorem, there exists a unique element $u_{\Phi^*(y)} \in \ell^2(\bbN)$.
