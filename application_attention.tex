...
\aanote[pdfcnote,noinline]{do we need to adjust this theorem according to the update version of the asymmetric relations theorem? e.g., approximation with respect to arbitrary norms, etc?}
