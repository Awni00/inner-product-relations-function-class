...
In this section, we will use the results developed above to analyze the ``attention'' mechanism which forms a key 
...
\begin{proof}
    ...
    Let $\bar{\epsilon} \coloneq (n-1) \exp\paren{- \frac{1}{2} \beta \eta_{\epsilon}}$. Then we have that,
    \begin{align*}
